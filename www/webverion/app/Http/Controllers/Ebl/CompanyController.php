...
class CompanyController extends ApiController
{
    ...
    public function view(){
        ...
        $read = Helper::showBasedOnPermission('company.read');   
     ...
     */
    public function new(){
        $add = Helper::showBasedOnPermission('company.create');   
    ...
    public function delete($id){
        ...
        $delete = Helper::showBasedOnPermission('company.delete');   
    ...
    public function edit($id){
        ...
        $edit = Helper::showBasedOnPermission('company.update');   
    ...
    public function update(Request $request){
        ...
        $update = Helper::showBasedOnPermission('company.update');   
