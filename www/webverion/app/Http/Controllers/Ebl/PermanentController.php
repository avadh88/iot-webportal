...
class PermanentController extends ApiController
{
    ...
    public function view(){
        ...
        $read = Helper::showBasedOnPermission('permanent.read');   
    ...
    public function delete($id){
        $delete = Helper::showBasedOnPermission('permanent.delete');   
    ...
    public function edit($id){
        ...
        $edit = Helper::showBasedOnPermission('permanent.update');   
