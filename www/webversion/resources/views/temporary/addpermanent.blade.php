                ...
                <div>
                    <div class="card-body">
                        ...
                        <div class="card border-primary">
                            ...
                            <div class="card-body">
                                @if(isset($data))
                                <form id="temporary_form" action="{{ route('permanent.insert',['id'=>$data->id]) }}" method="POST">
                                    <!-- @else    -->
                                    ...
                                    <input type="hidden" name="temp_device_id" @if(isset($data->temp_device_id)) value="{{ $data->temp_device_id }}" @endif>
