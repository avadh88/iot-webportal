                ...
                <div>
                    <div class="card-body">
                        ...
                        <div class="card border-primary">
                            ...
                            <div class="card-body">
                                @if(isset($data))
                                <form id="companyValidation" action="{{ route('company.update') }}" class="" method="POST" enctype="multipart/form-data" class=" form-bordered">
                                    @else
                                    <form id="companyValidation" action="{{ route('company.create') }}" class="" method="POST" enctype="multipart/form-data" class=" form-bordered">
                                        @endif
